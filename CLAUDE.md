...
```bash
npm test              # Run all tests (24 tests covering auth, CORS, validation, routing, caching)
...
Tests run inside a real Workers runtime (Miniflare), not Node.js. The `vitest.config.mts` injects test bindings:
